                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-striped table-hover first display nowrap">
                                            <a href="<?= BASEURL ?>/cs_funding/form_suku_bunga" class="nav-link">
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                    <a href="<?= BASEURL; ?>/cs_funding/edit_permohonan_suku_bunga/<?= $row['id_permohonan'] ?>" class="btn btn-outline-primary" id="edit"> Edit </a>
                                                                    ...
                                                                    <!-- <a href="<?= BASEURL; ?>/cs_funding/formulir_persetujuan_suku_bunga/<?= $row['id_permohonan'] ?>" class="btn btn-secondary" id="edit" style="pointer-events: none;">Print</a> -->
                                                                <?php
                                                                } else if ($row['status_permohonan'] == 'DIBATALKAN') {
                                                                ?>
                                                                    <a href="<?= BASEURL; ?>/cs_funding/edit_permohonan_suku_bunga/<?= $row['id_permohonan'] ?>" class="btn btn-secondary" id="edit" style="pointer-events: none;">Edit</a>
                                                                    ...
                                                                    <a href="<?= BASEURL; ?>/cs_funding/pengajuan_ulang_suku_bunga/<?= $row['id_permohonan'] ?>" class="btn btn-secondary" style="pointer-events: none;">Pengajuan Ulang</a>
                                                                    <button class="btn btn-outline-info" id="btn_modal_detail" data-id_permohonan="<?= $row['id_permohonan'] ?>">Detail</button>
                                                                <?php
                                                                ...
                                                                ?>
                                                                    <a href="<?= BASEURL; ?>/cs_funding/edit_permohonan_suku_bunga/<?= $row['id_permohonan'] ?>" class="btn btn-secondary" id="edit" style="pointer-events: none;">Edit</a>
                                                                    <!-- <button type='submit' id="hapus" class="btn btn-secondary btn_hapus" data-id_permohonan="<?= $row['id_permohonan'] ?>" data-nama_nasabah="<?= $row['nama_nasabah'] ?>" data-jenis_permohonan="<?= $row['jenis_permohonan'] ?>" style="pointer-events: none;"> Batal</button> -->
                                                                    <a href="<?= BASEURL; ?>/cs_funding/pengajuan_ulang_suku_bunga/<?= $row['id_permohonan'] ?>" class="btn btn-outline-primary">Pengajuan Ulang</a>
                                                                    <!-- <button type='submit' id="proses" class="btn btn-secondary btn_lanjutkan" data-id_permohonan="<?= $row['id_permohonan'] ?>" data-nama_nasabah="<?= $row['nama_nasabah'] ?>" data-jenis_permohonan="<?= $row['jenis_permohonan'] ?>" style="pointer-events: none;"> Proses Lanjutkan</button> -->
                                                                    <button class="btn btn-outline-info" id="btn_modal_detail" data-id_permohonan="<?= $row['id_permohonan'] ?>">Detail</button>
                                                                    <a href="<?= BASEURL; ?>/cs_funding/formulir_persetujuan_suku_bunga/<?= $row['id_permohonan'] ?>" class="btn btn-secondary" id="edit" style="pointer-events: none;">Print</a>
                                                                <?php
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <button class="btn btn-outline-info" id="btn_modal_detail" data-id_permohonan="<?= $row['id_permohonan'] ?>">Detail</button>
                                                                    <a href="<?= BASEURL; ?>/cs_funding/formulir_persetujuan_suku_bunga/<?= $row['id_permohonan'] ?>" class="btn btn-outline-primary" id="edit">Print</a>
                                                                <?php
                                                                } else {
                                                                ?>
                                                                    <a href="<?= BASEURL; ?>/cs_funding/edit_permohonan_suku_bunga/<?= $row['id_permohonan'] ?>" class="btn btn-secondary" id="edit" style="pointer-events: none;">Edit</a>
