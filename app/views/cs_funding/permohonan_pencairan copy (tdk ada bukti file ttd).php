...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    ...
                    <form id="form_funding_tambah_permohonan_pencairan" id="form_update" action="<?= BASEURL ?>/cs_funding/simpan_data_pencairan" method="POST" enctype="multipart/form-data">
                        <main class="content">
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-form-label">Jenis Permohonan Pencairan Sebelum Jatuh Tempo</label><span class="ml-1" style="color:red;">*</span>
                                                    ...
                                                    <div class="form-group" style="display:none" id="hidden_identitas_lain">
                                                        ...
                                                        <input type="text" class="form-control" id="nomor_identitas_lain" name="nomor_identitas_lain" oninput="this.value = this.value.toUpperCase()" maxlength="16">
                                                    </div>
                                                    ...
                                                    <div style="display:none" id="hidden_status_nasabah">
                                                        <label class="col-form-label">Status Nasabah</label><span style="font-style: italic; margin-left: 5px; font-size: 8px; color: green;">(Dicentang jika nasabah yang mengajukan sudah disetujui oleh Direksi)</span>
    ...
    <script>
        ...
        function validateForm() {
            ...
            // Lakukan pengecekan jika jangka waktu ada yang dipilih dan jenis produk sesuai
            if (select2.style.display !== "none" && selectedOption !== "") {
                if (select2.value === "") {
                    alert("Jangka waktu harus diisi!");
                    return false; // Menghentikan pengiriman formulir jika jangka waktu kosong
                }
            }
            return true; // Lanjutkan pengiriman formulir jika validasi lolos
        }
        ...
        dateInput.addEventListener("input", function() {
            ...
            // Buat objek tanggalJatuhTempoTerakhir dengan tanggalAwal dikurangi 1 hari
            var tanggalJatuhTempoTerakhir = new Date(tanggalAwal);
            tanggalJatuhTempoTerakhir.setDate(tanggalJatuhTempoTerakhir.getDate() - 1);

            // Hitung selisih bulan antara tanggalHariIni dan tanggalJatuhTempoTerakhir
            ...
            // Tambahkan selisih bulan ke tanggalJatuhTempoTerakhir
            tanggalJatuhTempoTerakhir.setMonth(tanggalJatuhTempoTerakhir.getMonth() + selisihBulan);

            // Jika tanggalHariIni lebih kecil dari tanggalJatuhTempoTerakhir, kurangi satu bulan dari tanggalJatuhTempoTerakhir
            if (tanggalHariIni < tanggalJatuhTempoTerakhir) {
                tanggalJatuhTempoTerakhir.setMonth(tanggalJatuhTempoTerakhir.getMonth() - 1);
            }

            // Hitung selisih waktu antara tanggal hari ini dan tanggal jatuh tempo terakhir
            var selisihWaktu = tanggalHariIni.getTime() - tanggalJatuhTempoTerakhir.getTime();

            // Konversi selisih waktu menjadi selisih hari dan bulatkan ke atas
            var selisihHari = Math.ceil(selisihWaktu / (1000 * 3600 * 24));

            // Jika tanggalJatuhTempoTerakhir berada pada bulan yang sama dengan tanggalHariIni, tambahkan 1 hari
            if (tanggalJatuhTempoTerakhir.getMonth() === tanggalHariIni.getMonth() && tanggalJatuhTempoTerakhir.getFullYear() === tanggalHariIni.getFullYear()) {
                tanggalJatuhTempoTerakhir.setDate(tanggalJatuhTempoTerakhir.getDate() + 1);

                // Hitung kembali selisih waktu setelah penambahan satu hari
                selisihWaktu = tanggalHariIni.getTime() - tanggalJatuhTempoTerakhir.getTime();

                // Konversi kembali selisih waktu menjadi selisih hari dan bulatkan ke atas
                selisihHari = Math.ceil(selisihWaktu / (1000 * 3600 * 24) - 1);
            }

            // Penyesuaian jumlah hari berdasarkan keberadaan bulan Februari dalam periode
            if (selisihBulan === 0) {
                // Jika periode hanya berlangsung dalam satu bulan
                if (tanggalJatuhTempoTerakhir.getMonth() === 1) {
                    // Jika periode termasuk bulan Februari
                    ...
                    // Jika periode tidak termasuk bulan Februari
                    selisihHari -= 1;
                }
            } else {
                // Jika periode mencakup bulan Februari
                selisihHari += (selisihBulan > 0 && tanggalJatuhTempoTerakhir.getMonth() === 1) ? 1 : -1;
            }
            console.log("selisih hari sebelum tambah hari : " + selisihHari);
