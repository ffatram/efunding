...
<head>
    ...
    <title>Daftar Permohonan (Disetujui)</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Daftar Permohonan (Disetujui)</h1>
                        </div>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?= number_format($row['nominal'], 0, ',', '.')  ?></td>
                                                                ...
                                                                <?php
                                                                if ($row['jenis_permohonan'] == 'SUKU BUNGA KHUSUS') {
                                                                    echo '<td>' . $row['nilai_suku_bunga_approval'] ." %". '</td>';
                                                                } else {
                                                                    echo '<td>' . $row['jenis_permohonan_pencairan_sebelum_jt_approval'] . '</td>';
                                                                }
                                                                ?>
                                                            ...
                                                            <td>
                                                                ...
                                                                if ($row['status_permohonan'] == 'TELAH DIPROSES') {
                                                                ?>
                                                                    <button type='submit' id="proses" class="btn btn-secondary btn_telah_diproses" data-id_permohonan="<?= $row['id_permohonan'] ?>" data-nama_nasabah="<?= $row['nama_nasabah'] ?>" data-jenis_permohonan="<?= $row['jenis_permohonan'] ?>" style="pointer-events: none;"> Telah Diproses</button>
                                                                <?php
                                                                } else {
                                                                ?>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <a href="<?= BASEURL; ?>/cs_funding/formulir_persetujuan_suku_bunga/<?= $row['id_permohonan'] ?>" class="btn btn-outline-primary">Print</a>
                                                                <?php
                                                                } else {
                                                                ?>
                                    ...
                                    success: function(res) {
                                        ...
                                        if (res.trim() == 'sukses') {
                                            Swal.fire({
                                                ...
                                                window.location.href = "<?= BASEURL; ?>/cs_funding/permohonan_disetujui";
                                            })
