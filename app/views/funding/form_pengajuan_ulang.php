...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    ...
                    <form id="form_funding_edit_data_pencairan" id="form_update" action="<?= BASEURL; ?>/funding/update_pengajuan_ulang_pencairan" method="POST">
                        <main class="content">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group" style="display:none" id="hidden_div">
                                                        ...
                                                        <input type="text" class="form-control" name="nominal_penalti" id="nominal_penalti"  onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" value="<?= "Rp " . number_format($data['data_id']['nominal_penalti'], 0, ',', '.')  ?>" disabled>
                                                        <?php
                                                        ...
                                                        <input type="text" class="form-control" name="nominal_bunga_berjalan" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" value="<?= "Rp " . number_format($data['data_id']['nominal_bunga_berjalan'], 0, ',', '.')  ?>" disabled>
                                                        ...
                                                        <select name="jenis_pencairan" id="jenis_pencairan" class="form-control" required data-nilai="<?php echo $data['data_permohonan']['jenis_permohonan_pencairan_sebelum_jt_pengajuan']; ?>">
    ...
    <script>
        ...
        btn_tolak.on('click', function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= BASEURL . '/funding/cek_btn_tolak' ?>',
                                    ...
                                    success: function(res) {
                                        ...
                                        if (res.trim() == 'sukses') {
                                            Swal.fire({
                                                ...
                                                window.location.href = "<?= BASEURL; ?>/funding/pencairan_sebelum_jatuh_tempo";
                                            })
