...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <!-- container fluid -->
                <div class="container-fluid">
                    <form id="form_funding_edit_data_pencairan" id="form_update" action="<?= BASEURL; ?>/funding/update_data_pencairan" method="POST" enctype="multipart/form-data">
                        <main class="content">
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="jenis_pencairan" id="jenis_pencairan" class="form-control" id="jenis_pencairan" required>
                                                        <?php
                                                ...
                                                <div class="form-group" style="display:none" id="hidden_identitas_lain">
                                                    ...
                                                    <input type="text" class="form-control" id="nomor_identitas_lain" name="nomor_identitas_lain" value="<?= $data['data_id']['nomor_identitas']  ?>" oninput="hanyaAngkaHuruf(event);this.value = this.value.toUpperCase()" maxlength="16">
                                                </div>
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" class="form-control" name="nominal_penalti" id="hidden_nominal_penalti" oninput="hanyaAngka1(this)" onkeyup="javascript:tandaPemisahTitik(this);" value="<?= number_format($data['data_id']['nominal_penalti'], 0, ',', '.')   ?>" oninput="hanyaAngka1(this)">
                                                    ...
                                                    <label class="col-form-label" style="display:none" id="label_jumlah_hari">Jumlah Hari Bunga Berjalan </label>
                                                    ...
                                                    <input type="hidden" class="form-control" name="nominal_bunga_berjalan" id="hidden_nominal_bunga_berjalan" oninput="hanyaAngka1(this)" onkeyup="javascript:tandaPemisahTitik(this);" value="<?= number_format($data['data_id']['nominal_bunga_berjalan'], 0, ',', '.')   ?>" oninput="hanyaAngka1(this)">
                                                </div>
    ...
    <script>
        ...
        //     // Menghapus semua karakter kecuali angka dari nilai input
        //     var sanitizedInput = input.value.replace(/[^\d]/g, '');

        //     // Memeriksa apakah nilai input tidak kosong dan bukan angka
        //     if (input.value !== sanitizedInput) {
        //         input.value = sanitizedInput; // Mengupdate nilai input dengan hanya angka dan tanda titik
        //         alert('Inputan hanya angka.');
        //     }
        // }

        function hanyaAngka1(input) {
            // Menghapus semua karakter kecuali angka dan tanda titik dari nilai input
            var sanitizedInput = input.value.replace(/[^\d.]/g, '');
        ...
        //     var sanitizedInput = input.value.replace(/[^A-Za-z]/g, '');

        //     // Memeriksa apakah nilai input tidak kosong dan tidak hanya terdiri dari huruf
        //     if (input.value !== sanitizedInput) {
        //         input.value = sanitizedInput; // Mengupdate nilai input dengan hanya huruf
    ...
    <script>
        function showDivLainnya(selectElement) {
            var selectedValue = selectElement.value;
            var hiddenDiv = document.getElementById("hidden_div_lainnya");
