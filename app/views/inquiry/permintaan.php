...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Daftar Permohonan Nasabah</h1>
                        ...
                        <div class="col-sm-6 d-flex justify-content-end">
                            ...
                            <div class="col col-lg-6">
                                ...
                                <!-- <a href="<?= BASEURL ?>/inquiry/excel" class="btn btn-outline-danger">Excel <i class="fa fa-file-excel" ></i></a> -->
                            </div>
                        </div>
                    </div>
                    <div class="row">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-cari', function(e) {
                ...
                data_table('/inquiry/get_daftar_permohonan').table.ajax.reload(null, false);
            })
    ...
    <script>
        $(document).on('click', '#btn_modal_detail', function(event) {
            ...
            $.ajax({
                type: 'post',
                url: '<?= BASEURL . '/inquiry/modal_detail' ?>',
                data: {
        ...
        $(document).on('click', '#btn_modal_pencairan', function(event) {
            ...
            $.ajax({
                type: 'post',
                url: '<?= BASEURL . '/inquiry/modal_detail_pencairan' ?>',
                data: {
                    'id_permohonan': id_permohonan
                },
                success: function(res) {
