...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Form Pengajuan Ulang Suku Bunga Khusus</h1>
                        </div>
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- <form id="form_pengajuan_ulang"> -->
                    <form id="form_pengajuan_ulang" id="form_update" type='submit' action="<?= BASEURL ?>/cs_funding/update_pengajuan_ulang_suku_bunga" method="POST">
                        <main class="content">
                                ...
                                <div class="row ">
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" class="form-control" name="jangka_waktu_awal" value="<?= $data['data_id']['jangka_waktu'] ?>">

                                                    <!-- <label class="mt-2 mb-2">Nama Funding</label><span class="ml-1" style="color:red;"></span>
                                                    <input type="text" class="form-control" name="nama_funding" value="<?= $data['data_id']['username']  ?>" required oninput="this.value = this.value.toUpperCase()" /> -->
                                                    ...
                                                    <input type="hidden" class="form-control" name="jenis_produk" value="<?= $data['data_id']['jenis_produk']  ?>">

                                                    <label class="mt-2 mb-2">Nomor KTP</label><span class="ml-1" style="color:red;"></span>
                                                    <input type="text" class="form-control" name="nomor_ktp" value="<?= $data['data_id']['nomor_ktp']  ?>" disabled />
                                                    <label class="col-form-label">Nama Nasabah</label>
                                                    <input type="text" class="form-control" name="nama_nasabah" disabled value="<?= $data['data_id']['nama_nasabah']  ?>">
                                                    ...
                                                    <input type="text" class="form-control" name="status_nasabah" value="<?= $data['data_id']['status_nasabah']  ?>" disabled>
                                                    <label for="alamat-text" class="col-form-label">Alamat</label>
                                                    <textarea class="form-control" name="alamat" disabled><?= $data['data_id']['alamat']  ?></textarea>
                                                    <label class="col-form-label">Nomor Telepon</label>
                                                    <input type="text" class="form-control" name="nomor_telepon" value="<?= $data['data_id']['nomor_telepon'] ?>" disabled>
                                                    <label class="col-form-label">Nominal</label>
                                                    <input type="text" class="form-control" name="nominal" value="<?= number_format($data['data_id']['nominal'], 0, ',', '.')  ?>"  oninput="hanyaAngka(event); tandaPemisahTitik(this)">
                                                    <input type="hidden" class="form-control" name="nominal_awal" value="<?= number_format($data['data_id']['nominal'], 0, ',', '.')  ?>">
                                                </div>
                                                ...
                                                <div class="form-group" style="display:none" id="hidden_div">
                                                    ...
                                                    <input type="text" class="form-control" name="norek_deposito" disabled value="<?= $data['data_id']['nomor_rekening_deposito']  ?>"> -->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6 col-xxl-6 ">
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label class="col-form-label">Suku Bunga Pengajuan Awal</label>
                                                    <input type="text" class="form-control" name="suku_bunga_pengajuan_awal" id="suku_bunga_pengajuan_awal" value="<?= $data['data_id']['nilai_suku_bunga_pengajuan']  ?>" disabled>
                                                    <input type="hidden" class="form-control" name="suku_bunga_awal" id="suku_bunga_awal" value="<?= $data['data_id']['nilai_suku_bunga_pengajuan']  ?>">
                                                    <label class="col-form-label">Suku Bunga Approval</label>
                                                    <input type="text" class="form-control" name="suku_bunga_approval" id="suku_bunga_approval" value="<?= $data['data_id']['nilai_suku_bunga_approval']  ?>" disabled>
                                                    <label for="alamat-text" class="col-form-label">Keterangan Approval</label>
                                                    <textarea class="form-control" name="keterangan_approval" disabled> <?= $data['data_id']['keterangan_approval']  ?></textarea>
                                                    <!-- pengambilan data awal -->
                                                    <input type="hidden" class="form-control" name="approval_awal" id="approval_awal" value="<?= $data['data_id']['nilai_suku_bunga_approval']  ?>">
                                                    <input type="hidden" class="form-control" name="tgl_approval_awal" id="tgl_approval_awal" value="<?= $data['data_id']['tgl_approval']  ?>">

                                                    <label class="col-form-label">Suku Bunga Pengajuan Ulang</label><span class="ml-1" style="color:red;">*</span>
                                                    ...
                                                    <input type="text" class="form-control" name="nama_keluarga" value="<?= $data['data_id']['nama_keluarga']  ?>" disabled>
                                                    <label for="alamat-text" class="col-form-label">Nilai Akumulasi Simpanan</label>
                                                    <input type="text" class="form-control" value="<?= number_format($data['data_id']['nilai_akumulasi_simpanan'], 0, ',', '.')  ?>" name="nilai_akumulasi_simpanan" disabled>
                                                    <label class="col-form-label">CIF Keluarga</label>
                                                    <input type="text" class="form-control" name="cif_keluarga" value="<?= $data['data_id']['cif_keluarga']  ?>" disabled>
                                                    <label class="col-form-label">Nomor Telepon Keluarga</label>
                                                    <input type="text" class="form-control" name="nomor_telepon_keluarga" value="<?= $data['data_id']['nomor_telepon_keluarga']  ?>" disabled> -->

                                                    <label for="alamat-text" class="col-form-label">Keterangan Funding</label>
                                                    <textarea class="form-control" name="keterangan_funding" oninput="this.value = this.value.toUpperCase()"> </textarea>
                                                    <!-- pengambilan data awal -->
                                                ...
                                                <button id="btn_form_pengajuan_ulang" type="submit" class="btn btn-primary btn-lg">Ajukan Ulang</button>
                                                <!-- <a onclick="btn_batal_update_kredit(event); return false" href="<?= BASEURL; ?>/cs_funding/suku_bunga" class="btn btn-danger btn-lg">Ditolak</a> -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <?php
                    if ($data['data_id']['jenis_produk'] == 'SI DEKA') {
                    ?>
                        <script>
    ...
    <script>
        ...
        // jadi
        $("#form_pengajuan_ulang").on('submit', function(e, params) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        icon: 'success',
                        title: 'Data Berhasil Diajukan Ulang',
                        showConfirmButton: false,
                        timer: 1500
                    }).then((result) => {
                        $("#form_pengajuan_ulang").off("submit").submit();
                    })
                }
            })
        })
