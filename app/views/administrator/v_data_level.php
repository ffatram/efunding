...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="clearfix mb-2">
                        <button type="button" class="btn btn-primary float-right modal-xl" data-target="#modal" data-toggle="modal"><i class="fas fa-plus"></i> Tambah Level</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="level" name="level" oninput="this.value = this.value.toUpperCase()" required>
        ...
        form.on('submit', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '<?= BASEURL . '/administrator/simpan_level' ?>',
                        data: data_form,
    ...
    <script>
        function load_halaman() {
            $.ajax({
                url: '<?= BASEURL ?>/administrator/tampil_level',
                type: 'get',
