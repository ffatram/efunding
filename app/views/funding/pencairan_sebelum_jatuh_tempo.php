...
<body class="hold-transition sidebar-mini layout-fixed">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-striped table-hover first display nowrap">
                                            <a href="<?= BASEURL ?>/funding/permohonan_pencairan" class="nav-link">
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                    <a href="<?= BASEURL; ?>/funding/edit_permohonan_pencairan/<?= $row['id_permohonan'] ?>" class="btn btn-outline-primary" id="edit">Edit</a>
                                                                ...
                                                                ?>
                                                                    <a href="<?= BASEURL; ?>/funding/edit_permohonan_pencairan/<?= $row['id_permohonan'] ?>" class="btn btn-secondary" id="edit" style="pointer-events: none;">Edit</a>
                                                                    <a href="<?= BASEURL; ?>/funding/form_pengajuan_ulang/<?= $row['id_permohonan'] ?>" class="btn btn-outline-primary">Pengajuan Ulang</a>
                                                                    <!-- <button type='submit' id="proses" class="btn btn-secondary btn_lanjutkan" data-id_permohonan="<?= $row['id_permohonan'] ?>" data-nama_nasabah="<?= $row['nama_nasabah'] ?>" data-jenis_permohonan="<?= $row['jenis_permohonan'] ?>" style="pointer-events: none;"> Proses Lanjutkan</button> -->
                                                                    <button class="btn btn-outline-info" id="btn_modal_detail" data-id_permohonan="<?= $row['id_permohonan'] ?>">Detail</button>
                                                                ...
                                                                ?>
                                                                    <a href="<?= BASEURL; ?>/funding/edit_permohonan_pencairan/<?= $row['id_permohonan'] ?>" class="btn btn-secondary" style="pointer-events: none;">Edit</a>
                                                                    ...
                                                                    <!-- <button type='submit' id="proses" class="btn btn-secondary btn_lanjutkan" data-id_permohonan="<?= $row['id_permohonan'] ?>" data-nama_nasabah="<?= $row['nama_nasabah'] ?>" data-jenis_permohonan="<?= $row['jenis_permohonan'] ?>" style="pointer-events: none;"> Proses Lanjutkan</button> -->
                                                                    <a href="<?= BASEURL; ?>/funding/form_pengajuan_ulang/<?= $row['id_permohonan'] ?>" class="btn btn-secondary" style="pointer-events: none;">Pengajuan Ulang</a>
                                                                    <button class="btn btn-outline-info" id="btn_modal_detail" data-id_permohonan="<?= $row['id_permohonan'] ?>">Detail</button>
                                                                <?php
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <button class="btn btn-outline-info" id="btn_modal_detail" data-id_permohonan="<?= $row['id_permohonan'] ?>">Detail</button>
                                                                    <a href="<?= BASEURL; ?>/funding/formulir_persetujuan/<?= $row['id_permohonan'] ?>" class="btn btn-outline-primary" id="edit">Print</a>
                                                                <?php
    ...
    <script>
        $(document).on('click', '#btn_modal_detail', function(event) {
            ...
            $.ajax({
                type: 'post',
                url: '<?= BASEURL . '/funding/modal_detail_pencairan' ?>',
                data: {
                    'id_permohonan': id_permohonan
                },
                success: function(res) {
