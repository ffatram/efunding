                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover mb-0">
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 200px; background-color: #F4F4F4; ">Tanggal Pembentukan/Perpanjangan</td>
                            ...
                            <tr>
                                ...
                                <td><?= $data['detail']['nomor_rekening_pencairan'] ?></td>
                            </tr>
                            <tr>
                                ...
                                <?php if (!empty($data['detail']['nama_gambar'])) : ?>
                                    ...
                                    <td>
                                        ...
                                        if ($fileExtension === 'pdf') {
                                            ...
                                            echo '<a href="' . BASEURL . '/upload/funding/' . $file . '" target="_blank">Buka File PDF</a>';  
                                        } else {
                                            // Jika bukan file PDF, tampilkan sebagai gambar seperti sebelumnya
                                            echo '<img src="' . BASEURL . '/upload/funding/' . $file . '" style="width:500px; height:270px;">';
                                        }
                                        ?>
                                        <br>
                                        <?= $file ?>
