        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Form Approval Permohonan Pencairan Sebelum Jatuh Tempo</h1>
                        </div>
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <?php if (empty($data['data_permohonan']['status_nasabah'])) { ?>
                                                        <label class="mt-2 mb-2" style="display: none;">Status Nasabah</label><span class="ml-1" style="color:red;"></span>
                                                        <input type="hidden" class="form-control" id="status_nasabah" name="status_nasabah" value="<?= $data['data_permohonan']['status_nasabah'] ?>" disabled />
                                                    <?php } else { ?>
                                                        <label class="mt-2 mb-2">Status Nasabah</label><span class="ml-1" style="color:red;"></span>
                                                        <input type="text" class="form-control" id="status_nasabah" name="status_nasabah" value="<?= $data['data_permohonan']['status_nasabah'] ?>" disabled />
                                                    <?php } ?>
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <?php
                                                    // $diff  = date_diff( date_create('2023-03-01'), date_create() );
                                                    // echo $diff->format(' %m Bulan %a Hari'); simpal dalam tag php di input jumlah hari
                                                    $tgl1 = new DateTime('2023-03-26');
                                                    $tgl2 = new DateTime();
                                                    ...
                                                    <textarea class="form-control" name="keterangan_funding" id="keterangan_funding" disabled><?= $data['data_permohonan']['keterangan_funding'] ?></textarea>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="display: none;" id='ket_reject'>
                                                </td>
        ...
        $(document).ready(function() {
            $('#form_approval_edit_data_approval').submit(function(e) {
                ...
                if (submitValue === 'approve') {
                    ...
                    event.preventDefault();
                    // alert(textarea);
                    // alert('Keterangan approval wajib diisi karena permohonan yang diajukan dan diapprove berbeda.');
                ...
                //     event.preventDefault();
                //     // alert(textarea);
                //     // alert('Keterangan approval belum diisi alasan permohonan ditolak.');
                //     header("Location: form_approval_pencairan.php");
                //     return false;
                //     // }
