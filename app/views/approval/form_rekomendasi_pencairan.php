...
<head>
    ...
    <title>Form Rekomendasi Pejabat Cabang</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <!-- container fluid -->
                <div class="container-fluid">
                    <!-- <form id="form_rekomendasi_pejabat"> -->
                    <form id="form_rekomendasi_pejabat" action="<?= BASEURL; ?>/approval/tambah_rekomendasi_pejabat" method="POST">
                        <main class="content">
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="cif" value="<?= $data['data_permohonan']['nomor_identitas'] ?>" disabled />
                                                    ...
                                                    <input type="text" class="form-control" name="nominal" value="<?= number_format($data['data_permohonan']['nominal'], 0, ',', '.')  ?>" disabled />
                                                    ...
                                                    <label class="mt-2 mb-2">Tanggal Pembuatan Deposito</label><span class="ml-1" style="color:red;"></span>
                                                    <input type="text" class="form-control" name="tgl_pembentukan" value="<?= $data['data_permohonan']['tgl_pembentukan'] ?>" disabled />
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="nominal_penalti" value="<?= number_format($data['data_permohonan']['nominal_penalti'], 0, ',', '.')  ?>" disabled />
                                                    ...
                                                    <input type="text" class="form-control" name="nominal_bunga_berjalan" value="<?= number_format($data['data_permohonan']['nominal_bunga_berjalan'], 0, ',', '.')  ?>" disabled />
                                                ...
                                                <button class="btn btn-success btn-lg" type="submit" id="btn_form_rekomendasi_pejabat" value="approve" data-id_permohonan="<?= $row['id_permohonan'] ?>">Verifikasi</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $("#form_rekomendasi_pejabat").on('submit', function(e, params) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        $("#form_rekomendasi_pejabat").off("submit").submit();
                    })
                }
            })
        })
