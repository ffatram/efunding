                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover mb-0">
                        <tbody>
                            ...
                            <!-- variabelnya namanya persentase penalti, tapi nilainya adalah suku buka deposito -->
                            <tr>
                            ...
                            <tr>
                                <?php if (empty($data['detail']['jenis_permohonan_pencairan_sebelum_jt_approval'])) { ?>
                                    <td style="width: 200px; background-color: #F4F4F4; display:none; ">Jenis Permohonan Pencairan Sebelum Jatuh Tempo Approval</td>
                                    <td style='display:none;'><?= $data['detail']['jenis_permohonan_pencairan_sebelum_jt_approval'] ?></td>
                                <?php } else { ?>
                            ...
                            <tr>
                                <?php if (empty($data['detail']['username_approval'])) { ?>
                            ...
                            <tr>
                                <?php if (empty($data['detail']['tgl_approval'])) { ?>
                                    <td style="width: 200px; background-color: #F4F4F4; display:none; ">Tanggal Approval</td>
                                    <td style='display:none;'><?= date('d F Y', strtotime($data['detail']['tgl_approval'])) ?></td>
                                <?php } else { ?>
