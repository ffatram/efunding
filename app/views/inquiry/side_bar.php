    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    <a href="<?= BASEURL ?>/inquiry/beranda" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?= BASEURL ?>/inquiry/permintaan" class="nav-link">
                        <i class="nav-icon fas fa-folder-open"></i>
                        <p>
                            Daftar Permohonan Nasabah
                        </p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?= BASEURL ?>/inquiry/download" class="nav-link">
