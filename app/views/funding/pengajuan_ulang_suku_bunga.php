        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    ...
                    <form id="form_pengajuan_ulang" id="form_update" type='submit' action="<?= BASEURL ?>/funding/update_pengajuan_ulang_suku_bunga" method="POST">
                        <main class="content">
                                        ...
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="nomor_ktp" value="<?= $data['data_id']['nomor_identitas']  ?>" disabled />
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="nominal" value="<?= number_format($data['data_id']['nominal'], 0, ',', '.')  ?>" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);">
                                                    ...
                                                    <input type="text" class="form-control" name="suku_bunga_pengajuan" id="suku_bunga_pengajuan" onkeypress="return hanyaAngka(event)" required>
